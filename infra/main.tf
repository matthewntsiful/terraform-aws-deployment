module "vpc" {
  ...
  source = "git@github.com:matthewntsiful/terraform-aws-modules.git//modules/vpc?ref=v0.1.28"
...
module "security-group" {
  ...
  source = "git@github.com:matthewntsiful/terraform-aws-modules.git//modules/security-group?ref=v0.1.28"
...
module "load-balancer" {
  ...
  source = "git@github.com:matthewntsiful/terraform-aws-modules.git//modules/load-balancer?ref=v0.1.28"
...
module "ec2" {
  ...
  source = "git@github.com:matthewntsiful/terraform-aws-modules.git//modules/ec2?ref=v0.1.28"
...
module "database" {
  ...
  source = "git@github.com:matthewntsiful/terraform-aws-modules.git//modules/database?ref=v0.1.28"
